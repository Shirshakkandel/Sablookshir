...
class Notification{
	...
	//constructor with con connection and User class object 
	...
	public function getUnreadNumber() {
		...
		//Notification in dropdown will be send back in $return_string string
	...
	public function getNotifications($data, $limit) {
		...
		while($row = mysqli_fetch_array($query)) {
			...
			$style = ($opened == 'no') ? "background-color: #DDEDFF;" : "";
					//Return of all notification in notification dropdown 
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		$link = "post.php?id=".$post_id;
				//Putting notification in database
