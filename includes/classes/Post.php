...
class Post { 
    ...
    public function submitPost($body, $user_to,$imageName){
		...
		if($check_empty != "") {
            ...
            //Insert notification by calling 'insertNotification' function from Notification class in Notification.php
            if($user_to != 'none') {
   ...
   public function calculateTrend($term) {
    ...
    public function loadPostsFriends($data,$limit){
        ...
        $userLoggedIn= $this->user_obj->getUsername();
            ...
            //Prepate user_to so it can be included even if not posted to a user
            ...
            //check if user who posted, has thier account close
            ...
            if($user_logged_obj->isFriend($added_by)){
                    ...
                    // at page=1,start=0,num_iteration=[0-9]  //at page=2, start=10,num_iteration=[10-19]  //at page=3, start=(3-2)*10=  20 ,num_iteration[20-29]
                ...
                continue; 
                    ...
                    if($count > $limit) { //in page 1 if count if it over 10 then it will end whole loop and go to equation $count > $limit to increase page by 1
                        break;
                    }
                    else {
                        $count++;
		...
		if($count > $limit) //here after 10 loads in every page if count<limit and loop end thats means all post is loaded so button having 'noMorePosts' value bacome true
